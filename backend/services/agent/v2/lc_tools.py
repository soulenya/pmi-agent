...
_TOOL_DOCS = {
    ...
    "create_email_draft": 'Draft an email into Communications → Email Drafts for the user to review and send — never sends anything. You write the full body yourself. JSON: {"subject": str, "body": str (full email, real line breaks, simple sign-off — no signature block), "recipient_email"?: str, "recipient_name"?: str, "cc"?: str (comma-separated addresses), "bcc"?: str, "purpose"?: str, "tone"?: "professional"|"friendly"|"formal"|"concise"|"empathetic"|"persuasive", "attachments"?: [str] (Generated Files filenames — create the file FIRST with create_docx/generate_file, then pass its returned filename; attached on approved send)}.',
