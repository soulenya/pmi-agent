...
_TOOL_DOCS = {
    ...
    "set_estimate_rates": 'Set how the estimate is totalled: mode "Simple" or "Cost build-up", and Fringe/Overhead/G&A/Fee percentages (30 means 30%). Only given fields change. Requires the per-budget permission. JSON: {"mode"?: "Simple"|"Cost build-up", "fringe_pct"?: number, "overhead_pct"?: number, "ga_pct"?: number, "fee_pct"?: number, "budget_title"?: str}.',
