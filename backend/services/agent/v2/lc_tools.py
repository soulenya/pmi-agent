...
_TOOL_DOCS = {
    ...
    "create_budget": 'Create a personal budget: a standardized Google Sheet on the USER\'s Drive + a Manage Budgets card. Self-serve, no approval. Gerry\'s entry-write permission stays OFF until the user enables it on the budget\'s page. JSON: {"title": str, "allotment"?: number, "categories"?: [str]}.',
