...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("probability_before", sa.Integer(), sa.CheckConstraint("probability_before BETWEEN 1 AND 5", name="ck_risk_items_probability_before"), nullable=True),
        sa.Column("severity_before", sa.Integer(), sa.CheckConstraint("severity_before BETWEEN 1 AND 5", name="ck_risk_items_severity_before"), nullable=True),
        sa.Column("mitigation_measures", sa.Text(), nullable=True),
        sa.Column("probability_after", sa.Integer(), sa.CheckConstraint("probability_after BETWEEN 1 AND 5", name="ck_risk_items_probability_after"), nullable=True),
        sa.Column("severity_after", sa.Integer(), sa.CheckConstraint("severity_after BETWEEN 1 AND 5", name="ck_risk_items_severity_after"), nullable=True),
