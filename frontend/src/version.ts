...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    build: 284,
    date: "2026-09-21",
    title: "Gerry can move a task under another task",
    changes: [
      "Ask Gerry to put existing tasks under a parent (\"move the four head tasks under IQT Projects\") and she does it in place — here or on the hub — keeping each task's id and history. She refuses loops and asks when a name matches more than one task.",
    ],
  },
  {
    build: 283,
    date: "2026-09-21",
    title: "On the hub shows your hub conversations",
    changes: [
      "Conversations begun on the hub were hidden behind the ones this computer had just carried up. Both lists now order by the last message wherever it was said, and show up to 200.",
    ],
  },
  {
    build: 282,
    date: "2026-09-21",
    title: "Gerry on the rail",
    changes: [
      "A Gerry place on the left rail, second after Today, opens the conversation list. The side panel's dropdown now lists hub conversations too (under On the hub) and has a button to open the current one on the Gerry page.",
    ],
  },
  {
    build: 281,
  ...
  },
  {
    build: 279,
    date: "2026-09-18",
    title: "Gerry knows a hub project's room",
    changes: [
      "In a hub project's conversation, Gerry now treats the project's room as the room she is in: pin to it, list it and log progress without naming it. Before, she saw only rooms on this computer and said she was not inside one.",
    ],
  },
  {
    build: 278,
  ...
  },
  {
    ...
    changes: [
      ...
      "A project's Budget tab has the Let Gerry manage entries switch, refreshes from the sheet every 30 seconds, and every project tab refetches when you open it. Double-click a budget card on the canvas to open the Budget tab.",
    ],
  },
  {
    build: 274,
  ...
  },
  {
    ...
    changes: [
      "On the hub, turn on Notifications on this device — in More on a phone, or Settings → Connections — and the things that ring the desktop bell reach that device even with the page closed: Team mentions, approvals waiting, tasks due, Gerry's suggestions. Tap one and it opens the right place. Send a test to check it lands.",
      "Works in Chrome, Edge and Firefox on Android and on laptops. On iPhone, add Little Gerry to your home screen first and open it from there; Safari only allows notifications for sites installed that way.",
      "Each device is its own subscription; turning it off on one leaves the others alone. A device that stops answering is dropped automatically.",
    ],
  },
  {
    build: 270,
  ...
  },
  {
    build: 262,
    date: "2026-09-11",
    title: "Select text inside a card",
    changes: [
      "Double-click the text of a sticky note, text box or shape on the canvas and a drag now selects the characters instead of moving the card. Escape or clicking away hands the card back, so a plain press-and-drag moves it as before.",
    ],
  },
  {
    build: 261,
    date: "2026-09-11",
    title: "Recording follows your headset",
    changes: [
      "Switching sound devices mid-call — speakers to a headset, or back — no longer stops the live transcript and the meeting note. Recording moves to the new default device within a couple of seconds and carries on as one recording. Unplugging a device pauses that side until one is available again instead of ending the capture.",
    ],
  },
  {
    build: 260,
  ...
  },
  {
    build: 236,
    date: "2026-09-04",
    title: "Pasted text is text",
    changes: [
      "Text pasted onto a canvas now lands as a text box, not a sticky note. A note is a decision; a paste is just words.",
      "Add to the canvas from the chat panel now asks what you want: text, a sticky note or a shape.",
    ],
  },
  {
    build: 235,
