...
r2 = subprocess.run([git, "-C", repo, "commit", "-m", "chore: remove _push31.py helper"], capture_output=True, text=True)
r3 = subprocess.run([git, "-C", repo, "push"], capture_output=True, text=True)
print(r2.stdout.strip() or "nothing")
print(r3.stdout.strip() or r3.stderr.strip() or "ok")
