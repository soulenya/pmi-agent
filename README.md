...
| **Workbench**              | The shell: a left rail of eight places (Today, Projects, Tasks, Mail, Knowledge, Calendar, Compliance, Finance) plus your last five places and a You menu; a search box (Ctrl+K) that jumps to any project, task, document, conversation or person by name, sends a question to Gerry, or runs `/` commands; a peek drawer that opens a task over the page you are on; and Gerry docked on the right, bound to the project you are in |
