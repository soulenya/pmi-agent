...
- **Canvas** — Infinite whiteboard with ink, images and live cards for real records; shapes hold text and restyle after placement; task-to-task links are real dependencies; the rail is the project's pool of tasks, budgets and pinned material; pasted text lands as a sticky note
