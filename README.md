...
| **Project canvas**         | An infinite whiteboard per project: sticky notes, text, shapes, frames, pressure-sensitive freehand ink and encrypted images, alongside live cards for tasks, documents, budgets, bookmarks, files and email threads dragged from the project's material. Cards show live state and open the real record on double-click. A line drawn between two task cards is a real dependency on the timeline. Undo/redo, align and distribute, snap to objects or grid, z-order, duplicate, copy-paste and keyboard shortcuts |
...
- **Canvas** — Infinite whiteboard with ink, images and live cards for real records; task-to-task links are real dependencies
