...
| **Workrooms**              | Persistent co-work spaces for work spanning days or weeks: a goal, a dedicated chat, a progress journal, and pinned artifacts (Drive docs, KB documents, generated files, notes, websites, email threads, tasks, Odoo records, regulatory documents, budgets) that Gerry carries into every message. Standing tasks, a morning digest, and Drive sharing so teammates can join their own mirror |
